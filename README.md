...
- Co-Authorship: The QtPass feature-parity work (clipboard, content panel, git sync, GPG user management and profiles) and the PyQt6 migration were co-written with the assistance of Claude from Anthropic.
